...
CUDA.@time @cuda threads=256 blocks=numblocks gpu_batched_tridiagonal_solve(jarrays.T_nplus, jarrays.N_layers-1, jarrays.N_c, jarrays.maindiag, jarrays.subdiag, jarrays.supdiag)
