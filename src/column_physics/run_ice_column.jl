...
function run_ice_column(jcolumn, atmodel)
    ...
    for step in 1:jcolumn.N_t
        ...
        run_column_step(jcolumn.N_i, jcolumn.N_s, jcolumn.N_t, jcolumn.H_i, jcolumn.H_s, jcolumn.T_frz,
...
@inline function run_column_step(N_i, N_s, N_t, H_i, H_s, T_frz, Δt, u_star, T_w,
