...
@inline function step_temp_change(jcolumn, step)
    ...
    generate_K(jcolumn.K, jcolumn.N_i, jcolumn.N_s, jcolumn.H_s, jcolumn.S, jcolumn.T_n)

    # Specific heat (length N_i+1), generated by formula
    generate_c_i(jcolumn.c_i, jcolumn.N_i, jcolumn.N_s, jcolumn.S, jcolumn.T_n, jcolumn.T_nplus)
    # Get the Matrix and RHS:
    generate_matrix_rhs(jcolumn.N_i, jcolumn.N_s, jcolumn.H_s, jcolumn.Δh, jcolumn.c_i, jcolumn.K, jcolumn.K̄, jcolumn.dF_0[step], jcolumn.F_0[step],
                        jcolumn.T_frz, jcolumn.I_pen, jcolumn.maindiag, jcolumn.subdiag, jcolumn.supdiag, jcolumn.T_n, jcolumn.T_nplus, jcolumn.Δt)
    ...
    tridiagonal_solve(jcolumn.T_nplus, jcolumn.N_i+jcolumn.N_s, jcolumn.maindiag, jcolumn.subdiag, jcolumn.supdiag)

    # Shift surface temperature back if no snow:
    if jcolumn.H_s < puny && jcolumn.N_s > 0
        jcolumn.T_nplus[1]             = jcolumn.T_nplus[jcolumn.N_s+1]
        jcolumn.T_nplus[jcolumn.N_s+1] = 0.0
    end
...
@inline function generate_c_i(c_i, N_i, N_s, S, T_old, T_new)
