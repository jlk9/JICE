...
@inline function step_temp_change(F_0, dF_0, jcolumn)
    ...
    generate_matrix_rhs(jcolumn.N_i, jcolumn.N_s, jcolumn.H_s, jcolumn.Δh, jcolumn.c_i, jcolumn.K, jcolumn.K̄, dF_0, F_0,
