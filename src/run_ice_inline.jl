...
function run_ice(jcmodel, atmodel)
    ...
    compute_surface_flux(jcmodel.α, jcmodel.i_0, jcmodel.N_t, jcmodel.F_0, jcmodel.dF_0, jcmodel.T_0[1], jcmodel.H,
                        atmodel.F_Lu, atmodel.F_s, atmodel.F_l, atmodel.dF_Lu, atmodel.dF_s, atmodel.dF_l,
                        atmodel.c_u, atmodel.c_Θ, atmodel.c_q, atmodel.U_a, atmodel.Θ_a, atmodel.Q_a, atmodel.atm_u_star,
                        atmodel.ρ_a, atmodel.L_vap, atmodel.L_ice, atmodel.c_p)
...
@inline function run_ice_step(N_i, S, L, T_frz, κ_i, Δh, Δh̄, T_old, T_new, c_i, K, K̄, I_pen, q_i, q_inew,
    ...
    while true
        ...
        (abs(T_old[1]-T_new[1]) > Tsf_errmax && iter < 10000000) || break
