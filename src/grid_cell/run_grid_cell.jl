...
function run_cell_step(jcell, step)
    ...
    for k in 1:length(jcell.areas)
        ...
        run_column_step(jcolumn.N_i, jcolumn.N_t, jcolumn.H_i, jcolumn.H_s, jcolumn.T_frz,
                        ...
                        jcell.atm.F_SWvdr, jcell.atm.F_SWidr, jcell.atm.F_SWvdf, jcell.atm.F_SWidf,
                        jcell.atm.F_Ld, jcell.atm.T_a, jcell.atm.Θ_a, jcell.atm.ρ_a, jcell.atm.Q_a, jcell.atm.c_p,
